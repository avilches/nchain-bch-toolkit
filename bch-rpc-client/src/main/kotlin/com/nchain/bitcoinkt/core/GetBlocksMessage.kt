...
open class GetBlocksMessage : Message {
    ...
    var version: Long = 0
    lateinit var locator: MutableList<Sha256Hash>
    ...
    override fun toString(): String {
        return "getblocks: " + locator.joinToString(" ")
    }

    @Throws(IOException::class)
    override fun bitcoinSerializeToStream(stream: OutputStream) {
        // Version, for some reason.
        ByteUtils.uint32ToByteStreamLE(params!!.getProtocolVersionNum(NetworkParameters.ProtocolVersion.CURRENT).toLong(), stream)
