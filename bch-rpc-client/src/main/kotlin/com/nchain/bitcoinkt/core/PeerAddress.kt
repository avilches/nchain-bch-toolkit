...
import com.nchain.tools.ByteUtils.uint32ToByteStreamLE
import com.nchain.tools.ByteUtils.uint64ToByteStreamLE
...
class PeerAddress : ChildMessage {
     ...
     */
    @JvmOverloads constructor(addr: InetAddress, port: Int = MainNetParams.port, protocolVersion: Int = NetworkParameters.ProtocolVersion.CURRENT.bitcoinProtocolVersion) {
