...
abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the bitcoinkt wire protocol.
     * <br></br>
    ...
    /**
     * Serialize this message to the provided OutputStream using the bitcoinkt wire format.
     *
     * @param stream
     * @throws IOException
     */
