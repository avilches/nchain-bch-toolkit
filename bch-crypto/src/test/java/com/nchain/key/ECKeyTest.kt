...
//        BriefLogFormatter.init()
    ...
    fun base58Encoding() {
        ...
        assertEquals(addr, key.toAddress(TestNet3Params).toString())
    }
    ...
    fun signTextMessage() {
        ...
        log.info("Message signed with " + key.toAddress(MainNetParams) + ": " + signatureBase64)
    ...
    fun verifyMessage() {
        ...
        val expectedAddress = LegacyAddress.fromBase58(MainNetParams, "14YPSNPi6NSXnUxtPAsyJSuw3pv7AU3Cag")
        val expectedCashAddress = CashAddressFactory.fromBase58(MainNetParams, "14YPSNPi6NSXnUxtPAsyJSuw3pv7AU3Cag")
        val key = ECKeySigner.signedMessageToKey(message, sigBase64)

        val gotAddress = key.toAddress(MainNetParams)
