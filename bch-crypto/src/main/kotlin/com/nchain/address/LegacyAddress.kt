...
//import com.nchain.bitcoinkt.params.Networks
//import com.nchain.bitcoinkt.script.Script

//import com.nchain.bitcoinkt.exception.AddressFormatException
//import com.nchain.bitcoinkt.exception.WrongNetworkException
 ...
 */
open class LegacyAddress : VersionedChecksummedBytes {
     ...
     * See also https://github.com/bitcoinkt/bips/blob/master/bip-0013.mediawiki: Address Format for pay-to-script-hash
     */
    open val isP2SHAddress: Boolean
        get() {
    ...
    constructor(params: NetworkParameters, version: Int, hash160: ByteArray) : super(version, hash160) {
        check(hash160.size == 20, {"Addresses are 160-bit hashes, so you must provide 20 bytes"})
    ...
    override fun clone(): LegacyAddress {
        return super.clone() as LegacyAddress
    }
    ...
    open fun toCashAddress(): String {
        return CashAddressFactory.fromBase58(this).toCashAddress()
    }
    ...
    companion object {
        ...
        fun fromP2SHHash(params: NetworkParameters, hash160: ByteArray): LegacyAddress {
            try {
                return LegacyAddress(params, params.p2SHHeader, hash160)
...
/*
        fun fromP2SHScript(params: NetworkParameters, scriptPubKey: Script): Address {
            check(scriptPubKey.isPayToScriptHash, "Not a P2SH script")
...
*/
         ...
         */
        @Throws(AddressFormatException::class)
        fun fromBase58(params: NetworkParameters?, base58: String): LegacyAddress {
            return LegacyAddress(params, base58)
        }
         ...
         */
        fun isAcceptableVersion(params: NetworkParameters, version: Int): Boolean {
