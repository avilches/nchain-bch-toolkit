 ...
 * @date 10/08/2018
 */
class ByteArrayMessageReader(val payload: ByteArray, var cursor:Int = 0):MessageReader {

    companion object {
        private val log = LoggerFactory.getLogger(ByteArrayMessageReader::class.java)
