...
/*
    ...
    public void testHashForSignature()
    {
        ...
        Transaction txConnected = new Transaction(MainNetParams.INSTANCE, HEX.decode(txConnectedData));
        Transaction tx = new Transaction(MainNetParams.INSTANCE, HEX.decode(txData));
